...
const RecipeForm: React.FC = () => {
    ...
    return (
        <form className='recipeForm' onSubmit={handleSubmit}>
            ...
            <textarea className='recipeForm__input recipeForm__textarea' name='steps' placeholder='Пошаговый рецепт приготовления' required onChange={handleChangeData}  value={newRecipe}/>
